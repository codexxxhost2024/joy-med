// Revised JOY config — human, natural, zero AI-jargon.
// Note: removed hardcoded API key. Use an environment variable instead.

export const CONFIG = {
  API: {
    // Use env var to avoid leaking credentials
